...
class Co2Controller extends ChangeNotifier {
  ...
  double? get averageCo2 => _averageCo2;
  ...
  void init(List<IotNode> allNodes) {
    ...
    _nodes = allNodes.where((n) {
      ...
      return search.contains('co2') || search.contains('air') || search.contains('cal');
    }).toList();
  ...
  Future<void> _loadData() async {
    try {
      ...
      debugPrint("Error cargando datos de CO2: $e");
    } finally {
      _isLoading = false;
      notifyListeners();
    }
  ...
  double? co2LevelOf(IotNode node) => _nodeValues[node.id];
